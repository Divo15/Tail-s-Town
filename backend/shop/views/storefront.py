...
PRODUCT_PAGE_DATA = {
    ...
    "water-fountain": {
        ...
        "description": "A gentle filtered flow for cats, small dogs, and shared pet corners that need cleaner daily hydration.",
    ...
    "litter-box": {
        ...
        "frame_video": "product-pages/assets/litter-motion-scrub.mp4",
        "frame_count": 260,
        "frame_label": "Scroll controlled 260-frame litter box animation",
