...
urlpatterns = [
    ...
    path('price-match-policy/', shop_views.price_match_page, name='price_match_page_root'),
    path('pages/price-match-policy/', shop_views.price_match_page, name='price_match_page_reference'),
    path('warranty-policy/', shop_views.warranty_page, name='warranty_page_root'),
    path('pages/warranty-policy/', shop_views.warranty_page, name='warranty_page_reference'),
    path('privacy-policy/', shop_views.privacy_page, name='privacy_page_root'),
    path('pages/privacy-policy/', shop_views.privacy_page, name='privacy_page_reference'),
    path('return-refund-policy/', shop_views.return_refund_page, name='return_refund_page_root'),
    path('pages/return-refund-policy/', shop_views.return_refund_page, name='return_refund_page_reference'),
